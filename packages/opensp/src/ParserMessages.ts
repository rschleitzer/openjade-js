...
export const numericCharRefUnknownDesc = new MessageType2(MessageType.Severity.error, null, -1, 'cannot convert character reference to number %1 because description %2 unrecognized');
export const numericCharRefUnknownBase = new MessageType3(MessageType.Severity.error, null, -1, 'cannot convert character reference to number %1 because character %2 from baseset %3 unknown');
export const numericCharRefBadInternal = new MessageType1(MessageType.Severity.error, null, -1, 'character reference to number %1 cannot be converted because of problem with internal character set');
export const numericCharRefNoInternal = new MessageType1(MessageType.Severity.error, null, -1, 'cannot convert character reference to number %1 because character not in internal character set');
...
// SGML declaration parameter parsing messages
export const sdEntityEnd = new MessageType1(MessageType.Severity.error, null, -1, 'entity end not allowed in SGML declaration parameter: expected %1');
export const sdInvalidNameToken = new MessageType2(MessageType.Severity.error, null, -1, '%1 is not a valid SGML declaration parameter: expected %2');
export const sdLiteralSignificant = new MessageType1(MessageType.Severity.error, null, -1, 'character %1 is not significant and not allowed in SGML declaration literal');
export const syntaxCharacterNumber = new MessageType1(MessageType.Severity.error, null, -1, '%1 is not a valid syntax character number');
export const sdParamInvalidToken = new MessageType2(MessageType.Severity.error, null, -1, 'token %1 is not allowed in SGML declaration: expected %2');
export const switchNotInCharset = new MessageType1(MessageType.Severity.error, null, -1, 'switch target %1 is not in syntax character set');
export const standardVersion = new MessageType1(MessageType.Severity.warning, null, -1, 'unrecognized SGML declaration version %1');
export const sgmlDeclRefRequiresWww = new MessageType0(MessageType.Severity.error, null, -1, 'SGML declaration reference requires WWW version');
export const invalidSgmlChar = new MessageType1(MessageType.Severity.error, null, -1, 'character %1 is not a valid SGML character');
export const explicitSgmlDecl = new MessageType0(MessageType.Severity.warning, null, -1, 'explicit SGML declaration');
export const badDefaultSgmlDecl = new MessageType0(MessageType.Severity.error, null, -1, 'default SGML declaration entity does not contain a valid SGML declaration');
export const sdMissingCharacters = new MessageType1(MessageType.Severity.error, null, -1, 'SGML declaration missing required minimum data characters: %1');
export const unknownBaseset = new MessageType1(MessageType.Severity.warning, null, -1, 'unknown base character set %1');
export const basesetCharsMissing = new MessageType1(MessageType.Severity.warning, null, -1, 'base character set missing characters %1');
export const missingMinimumChars = new MessageType1(MessageType.Severity.error, null, -1, 'document character set missing minimum data characters %1');
export const codeSetHoles = new MessageType1(MessageType.Severity.warning, null, -1, 'document character set has holes at %1');
export const duplicateCharNumbers = new MessageType1(MessageType.Severity.error, null, -1, 'character numbers declared more than once: %1');
export const zeroNumberOfCharacters = new MessageType0(MessageType.Severity.warning, null, -1, 'zero number of characters in DESCSET');
export const tooManyCharsMinimumLiteral = new MessageType0(MessageType.Severity.error, null, -1, 'too many characters specified with minimum literal (max 256)');
export const documentCharMax = new MessageType1(MessageType.Severity.error, null, -1, 'document character number exceeds maximum %1');
export const scopeInstanceSyntaxCharset = new MessageType0(MessageType.Severity.error, null, -1, 'syntax reference character set must be ISO 646 when SCOPE INSTANCE');
export const basesetTextClass = new MessageType1(MessageType.Severity.warning, null, -1, 'text class of public identifier %1 should be CHARSET');
export const sdTextClass = new MessageType1(MessageType.Severity.warning, null, -1, 'text class of public identifier %1 should be SD');
export const numberTooBig = new MessageType1(MessageType.Severity.error, null, -1, 'magnitude of %1 too big');
export const capacityTextClass = new MessageType1(MessageType.Severity.warning, null, -1, 'text class of public identifier %1 should be CAPACITY');
export const unknownCapacitySet = new MessageType1(MessageType.Severity.warning, null, -1, 'unknown capacity set %1');
export const duplicateCapacity = new MessageType1(MessageType.Severity.warning, null, -1, 'capacity %1 already specified');
