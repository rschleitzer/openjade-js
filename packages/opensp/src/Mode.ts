...
export enum Mode {
  ...
  proMode,           // prologue
  dsMode,            // declaration subset not in marked section nor in entity
  dsiMode,           // declaration subset in marked section or in entity
  ...
  sdplitMode,        // parameter literal starting with LIT in an SGML declaration
  sdplitaMode,       // parameter literal starting with LITA in an SGML declaration
  ...
  sdslitMode,        // system id literal starting with LIT in an SGML declaration
  sdslitaMode,       // system id literal starting with LITA in an SGML declaration
...
export const nModes = Mode.mconnetMode + 1;

export const minShortrefMode = Mode.econMode;
